...
struct MealPlan: Identifiable, Codable {
    ...
    /// Flag to indicate if this plan was generated by AI
    ...
    init(from decoder: Decoder) throws {
        ...
        // Decode isAIGenerated if present, otherwise default to false
        isAIGenerated = (try? container.decode(Bool.self, forKey: .isAIGenerated)) ?? false
    }
     ...
     *   - isAIGenerated: Whether this plan was generated by AI (default: false)
     */
    init(id: String, planId: String, meals: [String: [String: [Meal]]], createdAt: Date, updatedAt: Date, isAIGenerated: Bool = false) {
        self.id = id
        self.planId = planId
        self.meals = meals
